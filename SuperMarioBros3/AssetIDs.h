...
#define ID_SPRITE_TUNNEL_BEGIN_A (ID_SPRITE_TUNNEL+1000)
#define ID_SPRITE_TUNNEL_BEGIN_B (ID_SPRITE_TUNNEL+2000)
#define ID_SPRITE_TUNNEL_MIDDLE_A (ID_SPRITE_TUNNEL+3000)
#define ID_SPRITE_TUNNEL_MIDDLE_B (ID_SPRITE_TUNNEL+4000)
#define ID_SPRITE_TUNNEL_END_A (ID_SPRITE_TUNNEL+5000)
#define ID_SPRITE_TUNNEL_END_B (ID_SPRITE_TUNNEL+6000)